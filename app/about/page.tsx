                ...
                <article className="space-y-16">
                    <section>
                        ...
                        <div className="prose prose-gray max-w-none text-lg leading-relaxed text-gray-600 space-y-4">
                            ...
                            <p>
                                彼はそう言って、本当に電車に乗って相手のもとへ向かっていきました。
                            </p>
                            <p>
                                それを見たとき、正直「まさか、そこまでしなくても」と驚きを隠せませんでした。しかし同時に、今のインターネットがいかに大容量データの扱いにおいて不自由であるかを、ハッとさせられたのです。
                            </p>
                            <p>
                                現代には多くの転送サービスがありますが、その多くは「広告」「会員登録」「速度制限」といった壁に覆われていました。
                                大切な人にファイルを送るというシンプルな行為が、いつの間にか複雑なものになってしまっていたのです。
                            </p>
                            <p>
                                <b>「わざわざ電車に乗らなくても、ポストに手紙を投函するように、誰でも最高速で、安全に、そして温かく大きなファイルを届けられる場所を作りたい。」</b>
                            </p>
                            <p>
                                そんなもどかしさの解消と、手紙のようなシンプルさへの想い。その交差点に、Kizuna Transfer は生まれました。
                            </p>
                        </div>
                    </section>
